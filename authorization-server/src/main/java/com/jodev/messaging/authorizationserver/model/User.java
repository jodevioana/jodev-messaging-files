...
public class User extends BaseIdEntity implements UserDetails {
	...
	public User(String email, String username, String password, boolean enabled, boolean accountNonLocked, boolean accountNonExpired, boolean credentialsNonExpired, List<Role> roles) {
		this.email = email;
